...
<a href="#" class="easyui-linkbutton" style="width:80px;" onclick="addPanel()">删除车队</a>
</section>
	...
	<div title="所有帐号">
		...
		<thead>
			<tr>
				...
				<th data-options="field:'b',width:120,align:'center'">车队名称</th>
				<th data-options="field:'c',width:120,align:'center'">车队联系人</th>
				<th data-options="field:'d',width:120,align:'center'">车队联系电话</th>
			</tr>
		</thead>
		<tbody>
