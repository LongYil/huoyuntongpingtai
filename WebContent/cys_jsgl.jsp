...
<a href="javascript:void(0)" class="easyui-linkbutton" style="width:80px;margin-right:20px;" onclick="getSelected()">修改角色</a>
<a href="javascript:void(0)" class="easyui-linkbutton" style="width:80px;margin-right:20px;" onclick="shuaxin()">刷新</a>
	...
	<div title="所有角色">
		<table id="dg" class="easyui-datagrid" title="角色信息" style="width:1040px;height:590px"
