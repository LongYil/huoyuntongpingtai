...
<body class="easyui-layout" style="width:1040px;margin:0 auto;">
	...
	<ul class="menubox">
		...
		<li class="fatheritem">
        	<dl class="biaotia2">
            <li style="background-color:#dce8f3;">
            <a href="javascript:void(0)" ><img src="js/basic/caidanicon.png" class="menuicon">承运商</a>
            </li>
            </dl>
			<ul class="menu1">
				<li><a href="javascript:void(0)"><img src="js/basic/xiugai.png" class="itemicon">所有车队</a></li>
                <li><a href="javascript:void(0)"><img src="js/basic/xiugai.png" class="itemicon">所有线路</a></li>
			</ul>
		</li>
