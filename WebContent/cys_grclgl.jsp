...
<body style="padding:0px;margin:0px;">
	...
	<div class="easyui-panel" style="width:100%;max-width:840px;max-height:600px;padding:30px 60px;" title="车辆信息">
		<form id="ff" name="myform" action="${pageContext.request.contextPath}/clxx_save.action" class="easyui-form" method="post" data-options="novalidate:true">
			...
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" name="clkd" value="${clxx.clgd}" style="width:40%" data-options="label:'车辆高度',required:true">	
			</div>
			<div style="margin-bottom:20px">
