...
<body style="padding-top:0px; padding-bottom:0px;">
	...
	function tongyi(arg0){
		...
		rqt.open("POST","jyjl_ptTxwlb.action?id="+encodeURI(encodeURI(arg0)),false);
		rqt.send("");
	   };
	   function getresult(){
		   if(rqt.readyState == 4){
	...
	function bohui(arg0){
		...
		rqt.open("POST","jyjl_ptBhtxsq.action?id="+encodeURI(encodeURI(arg0)),false);
		rqt.send("");
	   };
	   function getresult1(){
		   if(rqt.readyState == 4){
	   ...
	   function yanchishuaxin(){
		   window.location="Jyjl_ptFindAllTxsq.action";
	   }
