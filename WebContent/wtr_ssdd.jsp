	...
	<div title="所有订单">
		...
		<thead>
			<tr>
				...
				<th data-options="field:'zz',width:200,align:'center'">操作</th>
			</tr>
		</thead>
		<tbody>
				...
				<tr>
					...
					<td>
					<a href="javascript:void(0)" class="easyui-linkbutton" onClick="pingjia('${item.dd.id}')">评价服务</a>
					<a href="javascript:void(0)" class="easyui-linkbutton" onClick="peichang('${item.dd.id}')">申请退款</a>
					</td>							
				</tr>
				</c:forEach>
		</tbody>
