...
<body style="padding:0px;margin:0px;">
	...
	<div class="easyui-panel" style="width:100%;max-width:840px;max-height:600px;padding:30px 60px;" title="添加车辆">
		<form id="ff" action="${pageContext.request.contextPath}/clxx_cd_save.action" class="easyui-form" method="post" data-options="novalidate:true">
