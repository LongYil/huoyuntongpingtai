...
<a href="javascript:void(0)" class="easyui-linkbutton" style="width:80px;" onclick="getSelected()">删除车辆</a>
<span class="cdmc">车队名称:${cdmc}${cdclid}</span>
</section>
	...
	<div title="所有车辆">
		...
		<thead>
			<tr>
				...
				<th data-options="field:'a',width:80,align:'center'">车辆编号</th>
				<th data-options="field:'a',width:80,align:'center'">所属车队</th>
