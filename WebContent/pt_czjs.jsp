...
<body style="padding:0px;margin:0px;">
	<div class="easyui-panel"  style="width:100%;max-width:830px;max-height:678px;padding:30px 60px;" title="重置角色">
		<form id="ff" name="myform" action="${pageContext.request.contextPath}/hyjs_cszj2.action" class="easyui-form" method="post" data-options="novalidate:true">
			
			<div style="margin-bottom:20px">
				<input class="easyui-textbox" name="jsmc" style="width:35%" data-options="label:'角色名称',required:true" value="${jsmc}">
			</div>
			<div style="margin-bottom:20px">
